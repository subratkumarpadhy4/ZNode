  ...
  return (
    <group>
      ...
      <mesh receiveShadow rotation={[-Math.PI / 2, 0, 0]} position={[0, 0, 0]}>
        ...
        <meshStandardMaterial color="#1a1d24" roughness={0.95} metalness={0.05} />
      </mesh>
      ...
      <mesh receiveShadow position={[0, ROOM_HEIGHT / 2, -ROOM_DEPTH / 2]}>
        ...
        <meshStandardMaterial color="#141821" roughness={0.98} metalness={0} />
      </mesh>
      ...
      {[-22, -11, 0, 11, 22].map((z) => (
        <mesh key={`girder-${z}`} position={[0, ROOM_HEIGHT - 0.4, z]} castShadow>
          ...
          <meshStandardMaterial color="#0a0d14" roughness={0.9} metalness={0.2} />
        </mesh>
      ))}
